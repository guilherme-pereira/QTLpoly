...
date: "2019-03-30 (last update `r Sys.Date()`)"
output:
  html_document:
    highlight: tango
    keep_md: yes
...
knitr::opts_chunk$set(cache = TRUE, echo = TRUE, eval = TRUE, results = 'hold', collapse = TRUE, tidy.opts = list(width.cutoff=75), tidy = TRUE, fig.width = 6, fig.height = 5, fig.align = 'center', fig.ncol = 1, prompt=TRUE)
```
...
This tutorial used `r R.version.string` running on either Ubuntu 18.04.1 LTS (64-bit) or Windows 10.
