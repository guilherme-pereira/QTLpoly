...
## ==============================
## MAPpoly Package [Version 0.2.1.004]
...
##   Calculation took 90.82 seconds
## 
## Null model for trait 2 'T17' 
##   Calculation took 91.01 seconds
## 
## Null model for trait 3 'T45' 
##   Calculation took 87.94 seconds
```
...
##   Calculation took 1593.64 seconds
## 
...
##   Calculation took 1082.62 seconds
## 
...
##   Calculation took 989.75 seconds
```
...
##   Calculation took 2361.12 seconds
## 
...
##   Calculation took 434.36 seconds
## 
...
##   Calculation took 497.32 seconds
```
...
##   Calculation took 930.9 seconds
## 
...
##   Calculation took 513.92 seconds
## 
## Forward search for trait 3 'T45'; there are no QTL in the model 
...
##   Calculation took 801.15 seconds
## 
## QTL profile for trait 2 'T17'; there is 1 QTL in the model 
##   Profiling QTL ... 193 
##   Calculation took 393.78 seconds
## 
## QTL profile for trait 3 'T45'; there is 1 QTL in the model 
##   Profiling QTL ... 184 
##   Calculation took 418.5 seconds
```
...
##   Refining QTL positions ... 152 ... 33 ... 100 
##   Profiling QTL ... 33 ... 100 ... 152 
##   Calculation took 3696.85 seconds
## 
...
##   Refining QTL positions ... 191 
##   Profiling QTL ... 193 
##   Calculation took 1075.56 seconds
## 
...
##   Refining QTL positions ... 178 
##   Excluding non-significant QTL ... 178 
##   Calculation took 924.03 seconds
```
...
<img src="1-tutorial_files/figure-html/unnamed-chunk-29-1.png" style="display: block; margin: auto;" /><img src="1-tutorial_files/figure-html/unnamed-chunk-29-2.png" style="display: block; margin: auto;" /><img src="1-tutorial_files/figure-html/unnamed-chunk-29-3.png" style="display: block; margin: auto;" />
...
<img src="1-tutorial_files/figure-html/unnamed-chunk-30-1.png" style="display: block; margin: auto;" />

```r
> plot_profile(data = data, model = remim.mod, grid = FALSE)
```

<img src="1-tutorial_files/figure-html/unnamed-chunk-30-2.png" style="display: block; margin: auto;" />
...
<img src="1-tutorial_files/figure-html/unnamed-chunk-34-1.png" style="display: block; margin: auto;" />
...
<img src="1-tutorial_files/figure-html/unnamed-chunk-36-1.png" style="display: block; margin: auto;" /><img src="1-tutorial_files/figure-html/unnamed-chunk-36-2.png" style="display: block; margin: auto;" /><img src="1-tutorial_files/figure-html/unnamed-chunk-36-3.png" style="display: block; margin: auto;" /><img src="1-tutorial_files/figure-html/unnamed-chunk-36-4.png" style="display: block; margin: auto;" />
...
<img src="1-tutorial_files/figure-html/unnamed-chunk-38-1.png" style="display: block; margin: auto;" /><img src="1-tutorial_files/figure-html/unnamed-chunk-38-2.png" style="display: block; margin: auto;" />
...
<img src="1-tutorial_files/figure-html/unnamed-chunk-44-1.png" style="display: block; margin: auto;" />
